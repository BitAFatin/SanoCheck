...
public class Dirt : MonoBehaviour
{
    ...
    [Header("Dirt")]
    [SerializeField] public Sprite dirtImage; //汚れ画像
    [SerializeField] public Sprite dirtImage2; //汚れ画像2

    [SerializeField] public bool hasSecondImage; //二つ目の画像を持っているか

    [Header("Cleanig")]
    [SerializeField] public Sprite cleaningImage; //掃除中の画像

    [Header("Cleaned")]
    [SerializeField] public Sprite cleanedImage; //掃除後の画像
    [SerializeField] public Sprite cleanedImage2; //掃除後の画像
